...
$site_top = "http://www.tokokai.or.jp/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "kikaku@tokokai.or.jp";
...
$Referer_check_domain = "tokokai.or.jp";
...
$BccMail = "tanaka@tokokai.or.jp,PMO-214042@tokokai.or.jp";
...
$thanksPage = "http://www.tokokai.or.jp/thanks.html";
...
if($requireCheck == 1) {
	...
	$empty_flag = $requireResArray['empty_flag'];fsendmail
}
//メールアドレスチェック
if(empty($errm)){
	foreach($_POST as $key=>$val) {
		if($val == "confirm_submit") $[ = 1;
