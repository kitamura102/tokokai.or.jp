...
<div class="custom_category_meta" style="margin:20px 0;">
 <h3 class="ccm_headline"><?php _e( 'Additional user data', 'tcd-serum' ); ?></h3>
...
<?php
    ...
    $staff_page_displayment = get_the_author_meta( 'staff_page_displayment', $user->ID );
    if(empty($staff_page_displayment)){
      $staff_page_displayment = 'type3';
    }

    $show_author = get_the_author_meta( 'show_author', $user->ID );
...
?>
  ...
  <h4 class="headline"><?php _e( 'Staff list page', 'tcd-serum' ); ?></h4>
  <div class="input_field cf">
   <div class="standard_radio_button">
    <input id="staff_page_displayment_type3" type="radio" name="staff_page_displayment" value="type3" <?php checked( $staff_page_displayment, 'type3' ); ?>>
    <label for="staff_page_displayment_type3"><?php _e('Don\'t display in staff list', 'tcd-serum'); ?></label>
    <input id="staff_page_displayment_type2" type="radio" name="staff_page_displayment" value="type2" <?php checked( $staff_page_displayment, 'type2' ); ?>>
    <label for="staff_page_displayment_type2"><?php _e('Display in staff list', 'tcd-serum'); ?></label>
    <input id="staff_page_displayment_type1" type="radio" name="staff_page_displayment" value="type1" <?php checked( $staff_page_displayment, 'type1' ); ?>>
    <label for="staff_page_displayment_type1"><?php _e('Display in representative information', 'tcd-serum'); ?></label>
   </div>
  </div><!-- END input_field -->

  <div class="staff_page_option">

  <h4 class="headline"><?php _e( 'Staff page image', 'tcd-serum' ); ?></h4>
  <div class="input_field">
   <div class="theme_option_message2">
    <p class="staff_page_option1"><?php printf(__('Recommend image size. Width:%1$spx, Height:%2$spx.', 'tcd-serum'), '930', '330'); ?></p>
    <p class="staff_page_option2"><?php printf(__('Recommend image size. Width:%1$spx, Height:%2$spx.', 'tcd-serum'), '880', '520'); ?></p>
   </div>
   <?php echo tcd_user_cf_media_form( 'staff_page_image', $user, 'medium' ); ?>
  </div><!-- END input_field -->

  <h4 class="headline"><?php _e( 'Official position', 'tcd-serum' ); ?></h4>
  <div class="input_field">
   <input type="text" name="user_position" value="<?php echo esc_attr( get_the_author_meta( 'user_position', $user->ID ) ); ?>" class="regular-text" />
  </div><!-- END input_field -->

  </div>

  <h4 class="headline"><?php _e( 'Profile in blog page', 'tcd-serum' ); ?></h4>
  <div class="input_field cf">
   <div class="standard_radio_button">
    <input id="show_author_yes" type="radio" name="show_author" value="1" <?php checked( $show_author, '1' ); ?>>
    <label for="show_author_yes"><?php _e('Display', 'tcd-serum'); ?></label>
    <input id="show_author_no" type="radio" name="show_author" value="2" <?php checked( $show_author, '2' ); ?>>
    <label for="show_author_no"><?php _e('Hide', 'tcd-serum'); ?></label>
   </div>
  </div><!-- END input_field -->
  ...
  <h4 class="headline"><?php _e( 'TikTok URL', 'tcd-serum' ); ?></h4>
  <div class="input_field">
   <input type="text" name="tiktok_url" value="<?php echo esc_attr( get_the_author_meta( 'tiktok_url', $user->ID ) ); ?>" class="regular-text" />
  </div><!-- END input_field -->

  <h4 class="headline"><?php _e( 'X URL', 'tcd-serum' ); ?></h4>
  <div class="input_field">
   <input type="text" name="twitter_url" value="<?php echo esc_attr( get_the_author_meta( 'twitter_url', $user->ID ) ); ?>" class="regular-text" />
  </div><!-- END input_field -->

  <h4 class="headline"><?php _e( 'Facebook URL', 'tcd-serum' ); ?></h4>
  <div class="input_field">
   <input type="text" name="facebook_url" value="<?php echo esc_attr( get_the_author_meta( 'facebook_url', $user->ID ) ); ?>" class="regular-text" />
  </div><!-- END input_field -->

  <h4 class="headline"><?php _e( 'Pinterest URL', 'tcd-serum' ); ?></h4>
  <div class="input_field">
...
<?php
	...
	// 以下全ユーザー
?>
  <h4 class="headline"><?php _e( 'Profile image', 'tcd-serum' ); ?></h4>
  <div class="input_field">
   <div class="theme_option_message2">
    <p><?php printf(__('Recommend image size. Width:%1$spx, Height:%2$spx.', 'tcd-serum'), '300', '300'); ?></p>
   </div>
...
function update_tcdw_profile_fields( $user_id ) {
	...
	if ( user_can( $user_id, 'edit_posts' ) ) {
		$meta_keys = array(
			...
			'staff_page_image' => $_POST['staff_page_image'],
			'staff_page_displayment' => $_POST['staff_page_displayment'],
