...
return text;},_n:function(singular,plural,count){if(count===1){return window.wfi18n.__(singular);}
return window.wfi18n.__(plural);}};if(typeof wp==='object'&&wp.i18n){window.wfi18n.sprintf=wp.i18n.sprintf;return;}
