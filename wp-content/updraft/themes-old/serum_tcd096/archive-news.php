...
<?php }; ?>
 ...
 <div class="news_category_button_wrap">
  <ol class="news_category_button">
   <li class="current"><a href="<?php echo esc_url(get_post_type_archive_link('news')); ?>"><?php _e('ALL', 'tcd-serum');  ?></a></li>
   <?php
    ...
    <ul class="meta">
     ...
     <?php
          ...
          if ( $category && ! is_wp_error($category) ) {
            ...
            endforeach;
     ?>
     <li><a class="category" href="<?php echo esc_url(get_term_link($cat_id,'news_category')); ?>"><?php echo esc_html($cat_name); ?></a></li>
     <?php }; ?>
    </ul>
   </div>
  </div>
